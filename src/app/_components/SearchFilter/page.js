...
const SearchFilter = ({ flightDataLength }) => {
    ...
    return <div className="col-xl-3 col-lg-4 col-md-12">
            ...
            <div className="filter-searchBar-head border-bottom">
                <div className="searchBar-headerBody d-flex align-items-start justify-content-between px-3 py-3">
                    ...
                    <div className="searchBar-headerlast text-end">
                        ...
                        <i onClick={toggleFilterVisible} className="fa-solid fa-filter"></i>
                    </div>
                </div>
            </div>

            {filterVisible && <div className="filter-searchBar-body">
                {/* <!-- Departure & Return --> */}
                ...
                <div className="searchBar-single px-3 py-3 border-bottom">
                    ...
                    <div className="searchBar-single-wrap">
                        <input type="text" className="js-range-slider" name="my_range" data-skin="round"
