...
const SearchFilter = () => {
    ...
    return <div class="col-xl-3 col-lg-4 col-md-12">
            ...
            <div class="filter-searchBar-head border-bottom">
                <div class="searchBar-headerBody d-flex align-items-start justify-content-between px-3 py-3">
                    ...
                    <div class="searchBar-headerlast text-end">
                        {filterVisible && <a href="#" class="text-md fw-medium text-primary active">Clear All</a>}
                        <i onClick={toggleFilterVisible} class="fa-solid fa-filter"></i>
                    </div>
                </div>
            </div>

            {filterVisible && <div class="filter-searchBar-body">
                {/* <!-- Departure & Return --> */}
