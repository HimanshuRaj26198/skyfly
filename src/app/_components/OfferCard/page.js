const OfferCard = () => {
    return <div class="col-xl-12 col-lg12 col-md-12">
        <div class="d-md-flex bg-success rounded-2 align-items-center justify-content-between px-3 py-3">
            ...
            <div class="flx-last text-md-end mt-md-0 mt-4"><a type="button" href="tel:+1-(888) 267-5955" class="btn btn-whites  full-width text-dark px-xl-4 contact_number"> +1-(888) 267-5955</a></div>
        </div>
    </div>
}
